...
//   실행순서를 임의로 조절하기 위하여 각 함수 호출문에 await 키워드를 부착한다.
// */
...
//   //이 함수가 true나 false를 return할것으로 기대하고
//   //작성을 했으나 비동기 방식의 이유로 중간의 return명령이 실행될 기회를 잃는다.
// };
...
//       문자열형 숫자를 숫자로 바꿀려고 할때
//       숫자형이 아닌 다른 데이터가 포함되러 숫자로 바꿀 수 없을 경우
//       java에서는 NumberFormatExcrption이 발생하고 코드가 중단된다.
...
//       NaN(숫자가 아니다), Undefinded(정의되지 않은 변수), null, 0 등등 몇몇의 데이터는 특별하게 사용된다.
