...
public interface MemberDao extends GenericDao<MemberVO, String>{
	...
	/*
	 * List가 아님 VO를 return type으로 가지는 findByEmail method구현
	 * 이 method가 잘 작동이 되기 위해서는 Entity 설계를 할때 
	 * email 칼럼은 반드시 UNIQUE 설정이 되어 있어야한다
	 * 좀더 정확한 설정을 위하여 NOT NULL 설정도 같이 하는것이 좋다.
	 */
