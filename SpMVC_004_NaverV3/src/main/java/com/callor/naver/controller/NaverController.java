...
public class NaverController {
	...
	//produces="application/json;charset=UTF-8" json 형태로 보여달라
...
/*
 * @RequestMapping(value="/books", method=RequestMethod.GET) public String
 * getBooks(String title, Model model){
 * 
 * String queryString = naverService.queryString("BOOK", title); List<BookVO>
 * bookList = naverService.getNaver(queryString);
 * 
 * model.addAttribute("BOOKS", bookList); return "naver/book_search"; } }
 */
