...
public class BooksController {
	...
	public String home() {
		/*
		 * return "문자열"형식은
		 * 명시적으로 어떤 jsp파일을 rendering 할 것인지
		 * 알려주는 것이다
	...
	public String list(Model model) {
		 ...
		 * 현재 method요청한 URL이 명시적으로 정확할 경우
	 ...
	 * GET요청이나 POST 요청을 모두 처리하는 method가 되버린다.
	 *
	 * method = RequestMethod.GET으로 지정을하면
	 * a tag link를 눌렀을대의 요청만 처리하도록 역할을 제한한다.
	 */
